...
| 2 | **Idiomas** | **Multilingüe europeo.** ES + EN completos; arquitectura lista para N idiomas; despliegue **por mercados** (`rollout: 'partial'`: el selector solo ofrece el idioma donde la página existe, nunca huérfanas). **Orden fijado por el dueño el 24-ago-2026: DE → FR (terminar) → IT → PT.** Cada idioma entra por un **núcleo de ~30 páginas** — las 30 primeras concentran el 53 % de las impresiones—, no por las ~400 de un idioma completo. ⚠️ **Neerlandés apuntado como candidato**: es el mercado con MÁS demanda desaprovechada (5.518 impresiones, posición 6,5, CTR 0,31 %), por encima de los cuatro elegidos; queda fuera por decisión del dueño, reconsiderar si los datos siguen así. Ver `docs/ESTRATEGIA-MULTIIDIOMA.md` | Se quiere otro orden de mercados o limitar idiomas |
