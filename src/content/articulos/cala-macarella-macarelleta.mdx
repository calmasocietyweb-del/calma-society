...
relatedPlaces:
  ...
  - cala-macarelleta-es
faq:
  # Pregunta paraguas añadida el 11-08-2026 (KAN-114): «cómo ir a cala macarella»
  # es la consulta-pregunta que más nos muestra en Search Console, y estábamos
  # en la posición 71 por no responderla de frente.
  - q: "¿Cómo ir a Cala Macarella?"
    a: "Depende de la época, y la diferencia es grande. Del 1 de junio al 30 de septiembre el coche está prohibido: se llega en bus desde el aparcamiento disuasorio de Ciutadella o caminando unos 2,8 km por el Camí de Cavalls desde Cala Galdana. Fuera de esos meses sí se puede acceder en coche. En cualquier caso, la regla de oro es llegar temprano."
  - q: "¿Se puede ir en coche a Cala Macarella?"
    a: "En verano no. Del 1 de junio al 30 de septiembre el acceso en coche a Macarella está prohibido (restricción en vigor desde 2018). Se llega en bus desde Ciutadella o a pie por el Camí de Cavalls desde Cala Galdana. Fuera de temporada sí se puede acceder en coche."
  - q: "¿Cómo se llega a Macarella en verano sin coche?"
    a: "En temporada, lo natural es el bus desde el aparcamiento disuasorio de Ciutadella (operado por Autocares Torres, e-Torres), con numerosas frecuencias diarias. La alternativa a pie es aparcar en Cala Galdana y caminar unos 2,8 km por el Camí de Cavalls. Confirma los horarios en las webs oficiales (cime.es y e-torres) antes de salir, porque cambian cada temporada."
  - q: "¿Cómo llegar a Cala Macarelleta?"
    a: "Solo se llega andando desde Macarella: un sendero de unos 10-15 minutos por el Camí de Cavalls, entre roca y pino, separa las dos calas. Es decir, primero hay que llegar a Macarella (en bus o a pie en verano, en coche fuera de temporada) y desde allí seguir a pie. No es camino de chanclas; lleva calzado para caminar."
  - q: "¿Macarelleta tiene servicios?"
    a: "No. Macarelleta no tiene ningún servicio —ni bar, ni sombra, ni papelera— y hay tolerancia naturista. Macarella, en cambio, sí tiene un chiringuito/restaurante. Si vas a la pequeña, baja autosuficiente: agua, comida y sombra propia."
  - q: "¿Cuándo es mejor ir a Macarella?"
    a: "Mayo, junio y septiembre son ideales. En pleno verano, la única hora tranquila es la primera de la mañana: llega temprano y tendrás esa arena blanca casi para ti."
---
...
Para encajar Macarella en el resto del viaje —y comprobar qué costa queda resguardada el día que vayas— tienes dos herramientas a mano:
