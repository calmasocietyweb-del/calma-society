...
## The first sunrise in Spain (eight months a year, to be exact)

Es Castell is the **easternmost municipality in Spain**, and from this comes its most repeated title: the first place in the country where the sun rises. It is true — but it deserves to be said precisely, which almost nobody does. **For eight months of the year the sun does reach here before anywhere else in Spain.** The other four, it doesn't: **between 23 April and 19 August** — the summer, precisely — the tilt of the Earth's axis brings the sunrise forward at **Cap de Creus**, at the northern tip of the Costa Brava, which sees the sun some four minutes earlier at the June solstice.

There is no need to treat it with the solemnity of a record: the lovely part is what lies behind it. A town oriented to the east, with its back to the rest of the peninsula, that wakes up facing the light.
