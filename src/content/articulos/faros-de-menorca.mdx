...
faq:
  - q: "¿Cuáles son los faros imprescindibles de Menorca?"
    a: "Los de referencia son cinco: Favàritx (noreste), Cap de Cavalleria (el punto más al norte), Punta Nati (noroeste, cerca de Ciutadella), Cap d'Artrutx (suroeste) e Illa de l'Aire (sur, sobre un islote frente a Punta Prima)."
  - q: "¿Se pueden visitar los faros de Menorca por dentro?"
    a: "No. Son instalaciones de señalización marítima en servicio y no se entra a las torres. Lo que se visita es el entorno: el cabo, el mirador y la costa, que es donde está la experiencia."
  - q: "¿Cuál es el mejor faro para ver el atardecer?"
    a: "Cap d'Artrutx, en el suroeste, porque el sol cae directamente sobre el agua sin tierra de por medio; y Punta Nati, cerca de Ciutadella, por su atardecer austero sobre la piedra. Favàritx destaca más por su paisaje lunar que por la puesta de sol."
  - q: "¿Cómo se llega a los faros?"
    a: "En coche hasta aparcamientos cercanos, con el último tramo a pie. En temporada alta, algunos puntos (Favàritx, Cavalleria) regulan el tráfico o el acceso, así que conviene ir temprano y comprobar la información local actualizada."
---
...
Si solo pudieras ver uno, que fuera [**Favàritx**](/lugar/faro-favaritx-es/). Se alza en un cabo del noreste, dentro del [**Parc Natural de s'Albufera des Grau**](/articulo/albufera-des-grau/), sobre un paisaje de **pizarra negra y plegada** que parece de otro planeta. No hay verde aquí; hay roca metálica, charcas saladas y un mar que, los días de viento, rompe con una violencia hipnótica.
...
[**Cap de Cavalleria**](/lugar/faro-cavalleria-es/) es el **punto más septentrional** de Menorca: el lugar donde la isla se asoma de lleno al mar abierto. Aquí los **acantilados rojizos**, el azul intenso y la inmensidad lo dominan todo. Es un faro de vistas largas, de sensación de fin del mundo amable.
...
Al **noroeste**, muy cerca de Ciutadella, [**Punta Nati**](/lugar/faro-de-punta-nati-es/) es el faro de la **soledad mineral**. El paisaje es de pura piedra: paredes secas, terreno pelado por el viento y las curiosas **barracas de pastor** de piedra en seco, esas construcciones tradicionales con forma escalonada que salpican el campo menorquín.

Aquí no hay distracción posible. Es austero, casi árido, y por eso su **atardecer** golpea tan fuerte: el sol cae al mar y la piedra se enciende. Por cercanía a [Ciutadella](/articulo/ciutadella-ciudad-de-palacios/), es el broche perfecto para una tarde en el oeste de la isla.

<Figure src="/uploads/faro-punta-nati.webp" alt="El faro de Punta Nati y la casa de los torreros al borde del acantilado, vistos desde el aire." caption="Punta Nati: el faro austero sobre la piedra desnuda, con el mar batiendo el acantilado." credit="Adobe Stock" lang="es" />
...
Para trazar la ruta por zonas y saber qué costa estará resguardada el día que salgas, apóyate en nuestras herramientas:
...
<MenorcaBusCTA lang="es" title="Los faros, sin conducir de noche" text="Favàritx, Cavalleria, Artrutx… quedan al final de caminos estrechos y remotos. Te llevamos y te recogemos en minibús privado, también para el atardecer." cta="Reserva tu excursión con Menorca Bus" />
