...
faq:
  # Pregunta paraguas añadida el 11-08-2026 (KAN-114). Teníamos doce preguntas de
  # transporte pero ninguna respondía la general, y la gente busca «desplazarse»
  # y «moverte», palabras que no aparecían en ninguna.
  - q: "¿Cómo desplazarse por Menorca?"
    a: "Hay cuatro maneras y conviene combinarlas. El coche de alquiler da libertad total para llegar a calas, faros y pueblos del interior, pero en verano varias calas restringen el acceso y los aparcamientos se llenan a media mañana. El autobús es económico y cubre el eje Maó–Ciutadella más lanzaderas a más de 25 playas en temporada, aunque con horarios fijos. El taxi funciona para trayectos puntuales, mejor reservado por teléfono fuera de los pueblos. Y para los trayectos que importan —el aeropuerto, una cena lejos, una cala de acceso restringido— está el traslado privado con conductor, a tu hora y con el precio cerrado. Para moverte dentro de Maó y Ciutadella, andando siempre es más rápido que conducir."
