...
Comprar bien en Menorca tiene menos que ver con encontrar un chollo que con entender el lugar. Aquí lo que más vale es invisible en una ficha inmobiliaria: la orientación frente a la tramontana, el silencio de un valle, la cercanía a un pueblo que respira fuera de temporada. Esta guía está pensada para el comprador internacional que quiere hacer las cosas con criterio, sin sorpresas y respetando lo que hace única a la isla.
...
- **Orientación y agua:** la **tramontana** condiciona la vida en el norte, y la gestión del agua importa mucho más de lo que parece en una isla.
