...
heroImageAlt: "reed beds and meadows of the Parc Natural de s'Albufera des Grau, the core of Menorca's Biosphere Reserve"
...
faq:
  - q: "Since when has Menorca been a Biosphere Reserve?"
    a: "Since 1993, when UNESCO recognised the entire island for its natural and cultural values. On 19 June 2019 the reserve was extended to the sea surrounding Menorca, out to 12 nautical miles."
  - q: "Is a Biosphere Reserve the same as a national park?"
    a: "No. A national park protects a specific area and restricts its uses; a UNESCO Biosphere Reserve covers, in this case, an entire inhabited island and promotes the balance between human activity and conservation. The natural park is s'Albufera des Grau, the core of maximum protection within the reserve."
  - q: "How large is Menorca's Biosphere Reserve?"
    a: "514,485 hectares after the 2019 marine extension (in 1993 it was 71,191 terrestrial hectares). The marine part accounts for 445,005 ha, 85% of the total: it is the Biosphere Reserve with the largest marine area in the Mediterranean."
  - q: "Who manages Menorca's Biosphere Reserve?"
    a: "The Consell Insular de Menorca, which coordinates its conservation through the Agència Menorca Reserva de Biosfera and safeguards the balance between use and protection that justified the recognition."
---
...
<Figure src="/uploads/cami-de-cavalls.webp" alt="Menorca's protected coastline seen from the Camí de Cavalls, with low vegetation beside the sea." caption="The protected coastline followed by the Camí de Cavalls, the historic path that circles the entire island." credit="Pelayo Arbués / Unsplash" lang="en" />
