...
Esta es una guía con criterio para quien sueña con [vivir el interior de la isla durante todo el año](/articulo/vivir-en-menorca-todo-el-ano): qué es el *marès*, cómo abordar una reforma sin traicionar la casa, qué cuesta de verdad y por qué este es, para nosotros, el lujo más sereno que ofrece Menorca.
...
<MenorcaBusCTA lang="es" title="Conoce la isla con chófer" text="Recorre los pueblos y las zonas de Menorca con conductor local mientras imaginas tu casa en la isla." cta="Consulta con Menorca Bus" />
