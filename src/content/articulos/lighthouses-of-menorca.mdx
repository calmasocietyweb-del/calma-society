...
# FAQ editorial (paridad con faros-de-menorca.mdx, KAN-87).
faq:
  - q: "Which are the essential lighthouses of Menorca?"
    a: "There are five landmarks: Favàritx (north-east), Cap de Cavalleria (the island's northernmost point), Punta Nati (north-west, near Ciutadella), Cap d'Artrutx (south-west) and Illa de l'Aire (south, on an islet off Punta Prima)."
  - q: "Can you go inside Menorca's lighthouses?"
    a: "No. They are working maritime signalling installations and the towers are not open to visitors. What you visit is the setting: the cape, the viewpoint and the coast — which is where the experience lies."
  - q: "Which lighthouse is best for sunset?"
    a: "Cap d'Artrutx, in the south-west, because the sun drops directly onto the water with no land in between; and Punta Nati, near Ciutadella, for its austere sunset over bare stone. Favàritx stands out more for its lunar landscape than for the sunset itself."
  - q: "How do you reach the lighthouses?"
    a: "By car to nearby car parks, with the final stretch on foot. In high season some points (Favàritx, Cavalleria) regulate traffic or access, so it is best to go early and check up-to-date local information."
---
...
If you could see only one, make it [**Favàritx**](/en/place/faro-favaritx-en/). It stands on a cape in the northeast, within the [**s'Albufera des Grau Natural Park**](/en/article/s-albufera-des-grau/), over a landscape of **black, folded slate** that looks like another planet. There is no green here; there is metallic rock, salt pools and a sea that, on windy days, breaks with a hypnotic violence.
...
[**Cap de Cavalleria**](/en/place/faro-cavalleria-en/) is the **northernmost point** of Menorca: the place where the island leans fully into the open sea. Here the **reddish cliffs**, the deep blue and the sheer vastness dominate everything. It is a lighthouse of long views, of a gentle end-of-the-world feeling.
...
To the **northwest**, very close to Ciutadella, [**Punta Nati**](/en/place/faro-de-punta-nati-en/) is the lighthouse of **mineral solitude**. The landscape is pure stone: dry-stone walls, ground stripped bare by the wind, and the curious **shepherds' huts** (*barraques*) of dry stone — those traditional stepped structures that dot the Menorcan countryside.

There is no possible distraction here. It is austere, almost arid, and that is why its **sunset** hits so hard: the sun drops into the sea and the stone catches fire. For its closeness to [Ciutadella](/en/article/ciutadella-city-of-palaces/), it is the perfect finish to an afternoon in the west of the island.

<Figure src="/uploads/faro-punta-nati.webp" alt="The Punta Nati lighthouse and its keeper's house on the cliff edge, seen from the air." caption="Punta Nati: the austere lighthouse on bare stone, with the sea beating the cliff below." credit="Adobe Stock" lang="en" />
...
To plan the route by area, and to know which coast will be sheltered on the day you set out, lean on our tools:
