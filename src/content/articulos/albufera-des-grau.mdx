...
heroImageAlt: "Carrizales y prados del Parc Natural de s'Albufera des Grau, con casas de campo al fondo."
...
faq:
  - q: "¿Qué es s'Albufera des Grau?"
    a: "El Parc Natural de s'Albufera des Grau es un humedal mediterráneo del noreste de Menorca —una gran laguna salobre separada del mar por una barra de arena, rodeada de marismas, islotes y pinares— y el núcleo de la Reserva de Biosfera declarada por la UNESCO en 1993. Es uno de los humedales más valiosos de las Baleares y un refugio clave para aves residentes y migratorias."
  - q: "¿Cuándo es mejor visitar s'Albufera des Grau?"
    a: "Al amanecer y en las medias estaciones. La primavera y el otoño ofrecen temperatura amable, paisaje verde y más trasiego de aves migratorias; en verano conviene madrugar para esquivar el calor y la afluencia. A primera hora la luz es suave, las aves están activas y el parque está casi vacío."
  - q: "¿Cómo se recorre el parque?"
    a: "Por itinerarios señalizados que parten de la zona de aparcamiento y bordean la laguna, con observatorios de aves y miradores sobre el agua. Son recorridos cómodos, sin grandes desniveles. Lleva agua y calzado cómodo, no salgas de los senderos y consulta los horarios actualizados del centro de visitantes, que varían según la temporada."
  - q: "¿Qué se puede combinar con la visita?"
    a: "El faro de Favàritx, a muy poca distancia y dentro de la misma área natural protegida: un cabo de pizarra oscura y plegada de aspecto casi lunar. La combinación clásica es la mañana en el humedal y la tarde en Favàritx, cuando la luz baja convierte la pizarra en plata."
---
...
- **Dónde:** en el **noreste de la isla**, a poca distancia en coche de [Maó](/articulo/mao-puerto/), junto al pueblecito costero de [Es Grau](/lugar/es-grau-es/).
...
Cuando Menorca fue declarada [**Reserva de Biosfera por la UNESCO en 1993**](/articulo/menorca-reserva-de-biosfera/), s'Albufera quedó reconocida como su **zona núcleo**: el área de máxima protección, el ejemplo de cómo la naturaleza y la mano humana pueden convivir sin destruirse. No es un parque temático ni un decorado: es un ecosistema vivo que la isla ha decidido cuidar. Caminar por aquí es entender por qué Menorca es lo que es.
